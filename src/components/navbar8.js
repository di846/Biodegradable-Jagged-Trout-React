        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text13">#solutions-benefits</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text21">#mission-vision</span>
                </Fragment>
              )}
            </a>
            <div
          ...
          <a href="#Pricing14" className="navbar8-link4">
              ...
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-body-small thq-link">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text16">#team-contacts</span>
                      </Fragment>
                    )}
                  </span>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Discover our mission and vision for the
                                  future.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text20">
                                  Explore the solutions we offer and the
                                  benefits they bring.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text14">
                                  Meet our talented team and find our contact
                                  information.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text20">
                            Explore the solutions we offer and the benefits they
                            bring.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page3: undefined,
  action1: undefined,
  page3ImageSrc: 'https://play.teleporthq.io/static/svg/default-img.svg',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1525972292986-69295aebf4cc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MzAxODI4M3w&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageAlt: 'Image representing Solutions & Benefits section',
  page2: undefined,
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page2ImageAlt: 'Image representing Mission & Vision section',
  ...
  page1: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1689149089574-df8982b19fdf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MzAxODI4M3w&ixlib=rb-4.0.3&q=80&w=1080',
  page1Description: undefined,
  page4: undefined,
  page2Description: undefined,
  link3Url: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1546188994-07c34f6e5e1b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MzAxODI4M3w&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage1: 'https://www.teleporthq.io',
  page1ImageAlt: 'Image representing Home section',
  action2: undefined,
  link1Url: 'https://www.teleporthq.io',
  linkUrlPage2: 'https://www.teleporthq.io',
  page4ImageAlt: 'Image representing Team & Contacts section',
}
