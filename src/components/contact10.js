        ...
        <div className="contact10-content3 thq-flex-row">
              ...
              {props.location1Description ?? (
                <Fragment>
                  <span className="contact10-text21">
                    123 Green Street, City Center, Country
                  </span>
                </Fragment>
              )}
            </p>
          ...
          <div className="contact10-container4">
            ...
            <h3 className="contact10-text14 thq-heading-3">
              {props.location2 ?? (
                <Fragment>
                  <span className="contact10-text16">Branch Office</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
              {props.location2Description ?? (
                <Fragment>
                  <span className="contact10-text18">
                    456 Park Avenue, Business District, Country
                  </span>
                </Fragment>
              )}
            </p>
...
Contact10.defaultProps = {
  location2: undefined,
  location1ImageSrc:
    'https://images.unsplash.com/photo-1651323230139-2d995d87efb4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MzAxODI4M3w&ixlib=rb-4.0.3&q=80&w=1080',
  content1: undefined,
